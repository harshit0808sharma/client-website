...
import { FaCut, FaSpa, FaStar, FaClock } from 'react-icons/fa';
...
const SalonServices = () => {
    if (!salonData?.services?.length) return null;
        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    ...
                    >
                        {salonData?.servicesHeading || "Experience our premium beauty services designed to enhance your natural beauty"}
                    </motion.p>
                </div>
